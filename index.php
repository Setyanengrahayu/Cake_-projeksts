...
<html lang="en-MU">
    ...
    <body>
        ...
        <div class="how-to-order">
            <div class="subtitle">
                <h2 class="order-subtitle">Easy 3-Step Order</h2>
            </div>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper0">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Ms. Srinika</b></p>
                            <p class="hierarchy">CEO - CakeWalk Bakery</p>
                            <p class="description">I appreciate your interest in CakeWalk Bakery and I encourage you to check the website to learn more about CakeWalk's history, growth, and range of products.
<br>
<br>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper1">
                        ...
                        <div class = "helper-more-about">
                            ...
                            <p class="description">Thanks to your continuous support we were able to build our top-quality brand and continue to grow. We pride ourselves in our quality products and customer satisfaction, and guarantee that you will visit us back for more! &#127873;</p>
                        </div>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper2">
                        ...
                        <div class = "helper-more-about">
                            ...
                            <p class="description">We are focused on providing top of the line, gourmet quality baked goods that won’t break the bank. At CakeWalk bakery we strive to create real guilt-free and delicious desserts that will put a smile on your face and leave you wanting more. &#127856;</p>
                        </div>
