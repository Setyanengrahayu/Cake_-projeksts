...
/*
                            ...
                            $headers = "From: cakewalk.cakeshop@gmail.com \r\n";
...
*/							
						$mail = new PHPMailer();
						  ...
						  $mail->SMTPSecure = "tls";
						  $mail->Port       = 587;
						  $mail->Host       = "smtp.gmail.com"; // change it according to your use - gmail or outlook  -- Step 1
						  $mail->Username   = ""; // add your gmail id here  -- Step 2
						  $mail->Password   = ""; // add your gmail password here  -- Step 3

						  $mail->IsHTML(true);
						  $mail->AddAddress($to, "recipient-name");
						  $mail->Subject = "CakeWalk - Email Verification";
						  $content = "<b>Click here to verify your account</b>
						  <a href='http://localhost/cakeshop/verifyEmail.php?vkey=$vkey'>Verify Email</a>";
