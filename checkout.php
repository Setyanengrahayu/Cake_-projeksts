  ...
  <div class="container">
    ...
    <main>
      ...
      <div class="py-5 text-center">
        <h1 class="business-name">CakeWalk</h1>
        <h2>Checkout Page</h2>
      </div>
          ...
          <ul class="list-group mb-3">
            ...
            foreach($_SESSION['shopping_cart'] as $key => $product){
              ...
              <li class="list-group-item d-flex justify-content-between lh-sm linen-rows">
                ...
                <span class="text-muted price-tag">&#8377; <?php echo number_format(($product['quantity']  * $product_row['p_price']),2); ?></span>
              </li>
            ...
            <li class="list-group-item d-flex justify-content-between total-row">
              <span>Total (&#8377;)</span>
              <strong class="price-tag">&#8377; <?php echo number_format($_SESSION['total_price'], 2); ?></strong>
            </li>
          </ul>
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
      <p class="mb-1">&#169; <?php echo date("Y"); ?> All rights reserved. Made with &#x1F49C; by <b><a href="https://www.youtube.com/channel/UC4_6-VSWBw_QHMyjrDDEvVQ"> GPW</a></b> Team.</p>
