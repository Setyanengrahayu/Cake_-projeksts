...
*/
					...
					$to = "";  // Change your TO: address here  - Step 1
                    if(isset($_POST['subject']))
                    {
                        $subject = test_input($_POST['subject']);
                    }
						  ...
						  $mail->Username   = ""; // add your sender gmail id here  -- Step 3
						...
						if(!empty($emailArray)){
							foreach($emailArray as $emailAddress){
								$mail->AddCC(trim($emailAddress));
							}
						} else{
							//This should not be the case.
							throw new Exception('No subscribed user emails found!');
						}
...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>CakeWalk | ADMIN PANEL</title>
