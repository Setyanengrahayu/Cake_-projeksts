...
<html>
    <head>
    <meta charset="utf-8">
    <title>CakeWalk | My Cart</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!--========== PHP CONNECTION TO DATABASE: CakeWalk ==========-->
    <?php 
            ...
            <div class="col-lg">
                ...
                <div class="cart_title_bar mx-1 ">
                    ...
                    <div class="cart-title-2">
                        <h3 class="section-all my-0 py-0 hide-wave">Item Details</h3>
                    </div>
                    <div class="cart-title-3">
                        <h3 class="section-all my-0 py-0 hide-wave">Quantity</h3>
                    </div>
                   
                    <div class="cart-title-4">
                        <h3 class="section-all my-0 py-0 hide-wave">Total Price (&#8377;) </h3>
                    </div>
                    <div class="cart-title-5">
                        <h3 class="section-all my-0 py-0 hide-wave">Remove</h3>
                    </div>
                ...
                <div class="receipt-card mt-2 mb-3 mx-1 py-3">
                    ...
                    <div class="">
                        ...
                        <div class="product-name">
                            <div class="product-name-det">
                                ...
                                <h6>&#8377; <?php echo number_format($product['price'], 2);?> / unit</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tot-price-per-item ">
                        <h6>&#8377; <?php echo number_format($product['quantity'] * $product['price'], 2); ?></h6>
                    </div>
            ...
            <div class="col-md container receipt-area mx-auto">
                ...
                <div class="row container receipt-data mx-auto pt-3">
                    ...
                    <div class="row container subtotal-area my-1">
                        <div class="col">
                            <h4 class="subtitle title-checkout">Sub total: </h4>
                        </div>
                        
                        <div class="col">
                            <h4 class="subtitle">&#8377; <?php echo number_format($total, 2); ?></h4>
                        </div>
                    </div>
                    <!-- delivery -->
                    <div class="row container delivery-area my-1">
                        <div class="col">
                            <h4 class="subtitle title-checkout">Delivery Charges: </h4>
                        </div>
                        
                        <div class="col">
                            <h4 class="subtitle">FREE* (Within city limit)</h4>
                        </div>
                    </div>
                    <!-- total -->
                    <div class="row container total-area my-1 pt-2">
                        <div class="col">
                            <h4 class="subtitle title-checkout">Total Amount: </h4>
                        </div>
